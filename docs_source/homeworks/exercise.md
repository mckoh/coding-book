...
Ziel dieses Übungsblatts ist es, 25 Punkte zu erreichen. Ihr könnt aus folgenden Aufgaben frei wählen. Erstellt für jede ausgewählte Aufgabe eine eigene Datei. Ihr könnt in Teams von zwei Personen arbeiten.

## Darts (<span style="color:#33FF7D ">Einfach</span>, 2 Punkte)
...
## Tic Tac Toe (<span style="color:#C70039">Herausfordernd</span>, 8 Punkte)
...
## Diamond (<span style="color:#FFB533 ">Mittel</span>, 4 Punkte)
...
## Palindrom prüfen (<span style="color:#33FF7D ">Einfach</span>, 2 Punkte)
...
## Längster String (<span style="color:#33FF7D ">Einfach</span>, 2 Punkte)
...
## Snake Case zu Camel Case (<span style="color:#FFB533 ">Mittel</span>, 4 Punkte)
...
## Personen (<span style="color:#FFB533 ">Mittel</span>, 4 Punkte)
...
## Bestellung (<span style="color:#C70039">Herausfordernd</span>, 8 Punkte)
...
## Primzahlen prüfen (<span style="color:#33FF7D ">Einfach</span>, 2 Punkte)
...
## Summe der umliegenden Felder (<span style="color:#C70039">Herausfordernd</span>, 8 Punkte)
...
## Gültige Passwörter (<span style="color:#FFB533 ">Mittel</span>, 4 Punkte)
...
## Schere, Stein, Papier, Echse, Spock (<span style="color:#C70039">Herausfordernd</span>, 8 Punkte)
...
## Conways Spiel des Lebens (<span style="color:#C70039">Herausfordernd</span>, 8 Punkte)
...
## Sekunden umrechnen (<span style="color:#FFB533 ">Mittel</span>, 4 Punkte)
...
## Primfaktorenzerlegung (<span style="color:#FFB533 ">Mittel</span>, 4 Punkte)
...
## Cäsarverschlüsselung (<span style="color:#FFB533 ">Mittel</span>, 4 Punkte)
...
## Fizz-Buzz (<span style="color:#33FF7D ">Einfach</span>, 2 Punkte)
...
## Memory (<span style="color:#C70039">Herausfordernd</span>, 8 Punkte)
